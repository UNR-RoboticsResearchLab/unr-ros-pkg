...
public:
        ...
        retry_(5)
    {
        ...
        sub = nh_.subscribe("node_control", 1000, &FrontierExplorationServer::nodeControlCallback, this); // subscriber
        nodeSuppressed = false; // flag
    }
...
private:
	...
	void nodeControlCallback(const std_msgs::Int8& msg)
	{
		if(msg.data == 1)
